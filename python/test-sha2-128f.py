...
class TestSHA2_128F_Address(unittest.TestCase):
...
class TestSHA2_128F_WotsPlus(unittest.TestCase):
    """Unit tests for WOTS+ stuff"""

    def test_pkgen(self):
        """Testing WOTS+ public key generation"""
        tv = read_json_test_vectors("../slh-dsa-sha2-128f-test-vectors.json")
        ctx = SLHDSA("SLH-DSA-SHA2-128f")
        pfx = "SLH-DSA-SHA2-128f WOTS+ "
...
class TestSHA2_128F_XMSS(unittest.TestCase):
...
class TestSHA2_128F_HT(unittest.TestCase):
...
class TestSHA2_128F_FORS(unittest.TestCase):
...
class TestSHA2_128F_SLH(unittest.TestCase):
...
class TestSHA2_128F_SLHREF(unittest.TestCase):
    """Unit test for SLH-DSA wrp hacked SPHINCS+ ref impl"""

    def test_sign(self):
        """Test signature generation"""
        tv = read_json_test_vectors("../slh-dsa-sha2-128f-ref-vectors.json")
        ctx = SLHDSA("SLH-DSA-SHA2-128f")
        pfx = "SLH-DSA-SHA2-128f SLH "
        sk           = tv[pfx+"SK"]
        sig_ref      = tv[pfx+"SIGNATURE"]
