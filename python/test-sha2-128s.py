...
class TestSHA2_128S_Address(unittest.TestCase):
...
class TestSHA2_128S_WotsPlus(unittest.TestCase):
    """Unit tests for WOTS+ stuff"""

    def test_pkgen(self):
        """Testing WOTS+ public key generation"""
        tv = read_json_test_vectors("../slh-dsa-sha2-128s-test-vectors.json")
        ctx = SLHDSA("SLH-DSA-SHA2-128s")
        pfx = "SLH-DSA-SHA2-128s WOTS+ "
...
class TestSHA2_128S_XMSS(unittest.TestCase):
...
class TestSHA2_128S_HT(unittest.TestCase):
...
class TestSHA2_128S_FORS(unittest.TestCase):
...
class TestSHA2_128S_SLH(unittest.TestCase):
...
class TestSHA2_128S_SLHREF(unittest.TestCase):
    """Unit test for SLH-DSA wrp hacked SPHINCS+ ref impl"""

    def test_sign(self):
        """Test signature generation"""
        tv = read_json_test_vectors("../slh-dsa-sha2-128s-ref-vectors.json")
        ctx = SLHDSA("SLH-DSA-SHA2-128s")
        pfx = "SLH-DSA-SHA2-128s SLH "
        sk           = tv[pfx+"SK"]
        sig_ref      = tv[pfx+"SIGNATURE"]
