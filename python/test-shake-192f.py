...
class TestSHAKE_192F_Address(unittest.TestCase):
...
class TestSHAKE_192F_WotsPlus(unittest.TestCase):
    """Unit tests for WOTS+ stuff"""

    def test_pkgen(self):
        """Testing WOTS+ public key generation"""
        tv = read_json_test_vectors("../slh-dsa-shake-192f-test-vectors.json")
        ctx = SLHDSA("SLH-DSA-SHAKE-192f")
        pfx = "SLH-DSA-SHAKE-192f WOTS+ "
...
class TestSHAKE_192F_XMSS(unittest.TestCase):
...
class TestSHAKE_192F_HT(unittest.TestCase):
...
class TestSHAKE_192F_FORS(unittest.TestCase):
...
class TestSHAKE_192F_SLH(unittest.TestCase):
...
class TestSHAKE_192F_SLHREF(unittest.TestCase):
    """Unit test for SLH-DSA wrp hacked SPHINCS+ ref impl"""

    def test_sign(self):
        """Test signature generation"""
        tv = read_json_test_vectors("../slh-dsa-shake-192f-ref-vectors.json")
        ctx = SLHDSA("SLH-DSA-SHAKE-192f")
        pfx = "SLH-DSA-SHAKE-192f SLH "
        sk           = tv[pfx+"SK"]
        sig_ref      = tv[pfx+"SIGNATURE"]
