...
class TestSHAKE_256F_Address(unittest.TestCase):
...
class TestSHAKE_256F_WotsPlus(unittest.TestCase):
    """Unit tests for WOTS+ stuff"""

    def test_pkgen(self):
        """Testing WOTS+ public key generation"""
        tv = read_json_test_vectors("../slh-dsa-shake-256f-test-vectors.json")
        ctx = SLHDSA("SLH-DSA-SHAKE-256f")
        pfx = "SLH-DSA-SHAKE-256f WOTS+ "
...
class TestSHAKE_256F_XMSS(unittest.TestCase):
...
class TestSHAKE_256F_HT(unittest.TestCase):
...
class TestSHAKE_256F_FORS(unittest.TestCase):
...
class TestSHAKE_256F_SLH(unittest.TestCase):
...
class TestSHAKE_256F_SLHREF(unittest.TestCase):
    """Unit test for SLH-DSA wrp hacked SPHINCS+ ref impl"""

    def test_sign(self):
        """Test signature generation"""
        tv = read_json_test_vectors("../slh-dsa-shake-256f-ref-vectors.json")
        ctx = SLHDSA("SLH-DSA-SHAKE-256f")
        pfx = "SLH-DSA-SHAKE-256f SLH "
        sk           = tv[pfx+"SK"]
        sig_ref      = tv[pfx+"SIGNATURE"]
