...
class TestSHAKE_256S_Address(unittest.TestCase):
...
class TestSHAKE_256S_WotsPlus(unittest.TestCase):
    """Unit tests for WOTS+ stuff"""

    def test_pkgen(self):
        """Testing WOTS+ public key generation"""
        tv = read_json_test_vectors("../slh-dsa-shake-256s-test-vectors.json")
        ctx = SLHDSA("SLH-DSA-SHAKE-256s")
        pfx = "SLH-DSA-SHAKE-256s WOTS+ "
...
class TestSHAKE_256S_XMSS(unittest.TestCase):
...
class TestSHAKE_256S_HT(unittest.TestCase):
...
class TestSHAKE_256S_FORS(unittest.TestCase):
...
class TestSHAKE_256S_SLH(unittest.TestCase):
...
class TestSHAKE_256S_SLHREF(unittest.TestCase):
    """Unit test for SLH-DSA wrp hacked SPHINCS+ ref impl"""

    def test_sign(self):
        """Test signature generation"""
        tv = read_json_test_vectors("../slh-dsa-shake-256s-ref-vectors.json")
        ctx = SLHDSA("SLH-DSA-SHAKE-256s")
        pfx = "SLH-DSA-SHAKE-256s SLH "
        sk           = tv[pfx+"SK"]
        sig_ref      = tv[pfx+"SIGNATURE"]
